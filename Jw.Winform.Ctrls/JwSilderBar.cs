...
{
    public class JwSilderBar : Control
    {
        ...
        [Description("保留小数位数"), Category("JwSilderBar")]
        ...
        [Description("表示类型[百分比,实际值]"), Category("JwSilderBar")]
        ...
        [Description("最小值"), Category("JwSilderBar")]
        ...
        [Description("最大值 "), Category("JwSilderBar")]
        ...
        [Description("总刻度背景色"), Category("JwSilderBar")]
        ...
        [Description("值的背景色"), Category("JwSilderBar")]
        ...
        [Description("Thumb背景色"), Category("JwSilderBar")]
        ...
        [Description("Thumb边框色"), Category("JwSilderBar")]
        public Color ThumbOutColor
        {
            get => _ThumbOutColor;
            set
            {
                _ThumbOutColor = value;
                this.Refresh();
            }
        }
        ...
        [Description("值文字显示格式"), Category("JwSilderBar")]
        ...
        [Description("当前值"), Category("JwSilderBar")]
        public float Value
        {
            get => _Value;
            set
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            {
                using (var lineBorder = new Pen(_LeftColor, 0.1f))
                {
                    if (this.Radius == 0)
                    {
            ...
            {                
                using (var brush = new SolidBrush(_LeftColor))
                {
                    if (this.Radius == 0)
                    {
            ...
            if (ThumbVisble)
            {
                ...
                using (var brush = new SolidBrush(_ThumbOutColor))
                {
