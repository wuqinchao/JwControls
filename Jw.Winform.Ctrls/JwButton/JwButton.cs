...
namespace Jw.Winform.Ctrls
{
    ...
    [Designer("Jw.Winform.Ctrls.JwButtonDesigner")]
    public class JwButton : Control, IButtonControl, IIconfont, IJwTheme
    {
        public JwButton()
        {
        ...
        [Description("圆角"), Category("JwButton")]
        public int Radius
        {
            get => _Radius;
            set
        ...
        [Description("配色方案"), Category("JwButton")]
        ...
        [Description("图标大小"), Category("JwButton.Icon")]
        public int IconSize
        {
            get => _IconSize;
            set
        ...
        [Description("图标颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("激活时图标颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("背景颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("激活时背景颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("禁用时背景颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("激活时文字颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("禁用时文字颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("边框颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("激活时边框颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("禁用时边框颜色,不使用Theme时有效果"), Category("JwButton.Theme")]
        ...
        [Description("边框宽度"), Category("JwButton")]
        ...
        [Description("图标"), Category("JwButton.Icon")]
        ...
        [Description("图标与文字间距(有文字是有效)"), Category("JwButton")]
        ...
        [Description("是否自动设置控件大小"), Category("JwButton")]
        ...
        [Description("内容是否水平居中"),Category("JwButton")]
        ...
        [Description("是否显示获得焦点状态"),Category("JwButton")]
        ...
        [Description("图标与上边距离微调"), Category("JwButton")]
        ...
        [Description("使用图标字体的名称(注册时的名称)"), Category("JwButton")]
        ...
        private Font GetIconFont()
        {
            ...
            var font = new Font(JwIconfontManager.GetFontFamily(IconFontName), size, FontStyle.Regular, GraphicsUnit.Point);
            return font;
        }
        ...
        private JwButtonThemeStatus CustomTheme = new JwButtonThemeStatus()
        {
        ...
        public JwButtonThemeStatus ThemePrivate
        {
            get
            {
                if (Theme != ThemeType.None)
                {
                    return JwTheme.JwButtonThemeDict[Theme];
                }
                else
                {
                    return CustomTheme;
